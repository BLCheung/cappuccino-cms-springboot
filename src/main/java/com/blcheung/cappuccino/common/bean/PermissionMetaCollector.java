package com.blcheung.cappuccino.common.bean;
...
public class PermissionMetaCollector implements BeanPostProcessor {
     ...
     * 获取所有路由信息
     *
     * @return java.util.Map<java.lang.String, com.blcheung.cappuccino.common.bean.RouterInfo>
     * @author BLCheung
     ...
     *
     * @param identity
     * @return com.blcheung.cappuccino.common.bean.RouterInfo
     * @author BLCheung
     * @date 2022/1/5 10:18 下午
     */
