...
public interface GridCategoryService extends IService<GridCategoryDO> {
     ...
     *
     * @param gridId
     * @return java.util.Optional<com.blcheung.zblmissyouadmin.model.GridCategoryDO>
     * @author BLCheung
     ...
     *
     * @param dto
     * @return com.blcheung.zblmissyouadmin.vo.GridCategoryVO
     * @author BLCheung
     ...
     * 获取所有宫格数据
     *
     * @return java.util.List<com.blcheung.zblmissyouadmin.vo.GridCategoryVO>
     * @author BLCheung
